...
function renderProductCard(element) {
  ...
  const totelstock = Math.max(element.stock - element.bag - cartquan, 0);
  var tech_spec = "";
          ...
          <div class="product-cart">
            ...
            <div>
              <div class="wrap">
                ...
                <input class="count" type="number" step="0.1" data-val="${element.stock}"  data-index="${element.id}" value="${cartquan}" min="1" max="1000" />
